            ...
            >
              ...
              >
                ...
                <div className="space-y-3 text-base text-slate-600 dark:text-slate-300">
                  <p><strong>Role:</strong> {selectedCompany.jobTitle || "Not specified"}</p>
                  <p><strong>Package:</strong> {selectedCompany.package || "Not specified"}</p>
                  <p><strong>Location:</strong> {selectedCompany.location || "Not specified"}</p>
                  <p><strong>Min CGPA:</strong> {selectedCompany.minCgpa || "N/A"}</p>
                  <p><strong>Batch:</strong> {selectedCompany.batch}</p>
                </div>
              </div>
            </div>
          </>
