            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  {...register("name")}
                  className={`${inputBaseStyle} ${errors.name ? inputErrorStyle : inputFocusStyle}`}
              ...
              <div>
                ...
                <input
                  ...
                  {...register("email")}
                  className={`${inputBaseStyle} ${errors.email ? inputErrorStyle : inputFocusStyle}`}
                  disabled={isSubmitting}
                />
              ...
              <div>
                ...
                <input
                  ...
                  {...register("phone")}
                  className={`${inputBaseStyle} ${errors.phone ? inputErrorStyle : inputFocusStyle}`}
                  disabled={isSubmitting}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`${inputBaseStyle} ${errors.companyName ? inputErrorStyle : inputFocusStyle}`}
                  disabled={isSubmitting}
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  {...register("message")}
                  className={`${inputBaseStyle} ${errors.message ? inputErrorStyle : inputFocusStyle} resize-none`}
                  disabled={isSubmitting}
                ></textarea>
